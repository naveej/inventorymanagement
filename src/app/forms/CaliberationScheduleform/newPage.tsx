...
const formSchema = z.object({
  ...
  departmentName: z
    ...
    instrumentName: z.string().min(1, { message: "Instrument Name is required." }),
    instrumentNo: z.string().min(1, { message: "Instrument No is required." }),
    frequencyOfCalibration: z.string().min(1, { message: "Frequency of Calibration is required." }),
    typeOfInstrument: z.string().min(1, { message: "Type of Instrument is required." }),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="Frequency Of Calibration" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
